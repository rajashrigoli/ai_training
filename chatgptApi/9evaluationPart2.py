...
print("\n\n")
print(dash_line)
print("Evaluate the LLM's answer to the user with a rubric, based on the extracted product information")
print(dash_line)
...
print("\n\n")
print(dash_line)
print("Evaluate the LLM's answer to the user based on an \"ideal\" / \"expert\" (human generated) answer.")
print(dash_line)
...
print("\n\n")
print(dash_line)
print("Check if the LLM's response agrees with or disagrees with the expert answer")
print(dash_line)
