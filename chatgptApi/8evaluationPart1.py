...
print(equal_line)
print("Modify the prompt to work on the hard test cases")
print(equal_line)
...
print(equal_line)
print("### Gather development set for automated testing")
print(equal_line)
...
print(equal_line)
print("Evaluate test cases by comparing to the ideal answers")
print(equal_line)
def eval_response_with_ideal(response, ideal, debug=False):
    ...
    # extract only the JSON array, ignoring any extra text before/after
    match = re.search(r'\[.*\]', json_like_str, re.DOTALL)
    if match:
...
print(equal_line)
print("Run evaluation on all test cases and calculate the fraction of cases that are correct")
print(equal_line)
